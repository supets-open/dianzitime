...
import com.supets.map.led2.baiduaudio.utils.FileUtil;
...
public class CommonRecogParams {
    ...
    public Map<String, Object> fetch(SharedPreferences sp) {
        ...
        map.put("disable-punctuation", false);
        map.put("accept-audio-volume", true);
        map.put("pid", 1536);
    ...
    /**
     * 根据 stringParams intParams boolParams中定义的参数名称，
     * 提取SharedPreferences相关字段
     *
     * @param sp
     * @param map
     */
